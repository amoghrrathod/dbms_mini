...
-- Create the tables (lowercase version)
create table users (
...
-- game_tags (linking games to tags)
...
-- user_achievements (who unlocked what)
...
-- item_instances (who has what item instance)
